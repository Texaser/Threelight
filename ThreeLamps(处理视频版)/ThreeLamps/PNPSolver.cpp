...
PNPSolver::PNPSolver(double fx, double fy, double u0, double v0, double k_1, double  k_2, double  p_1, double  p_2, double k_3, double x_1,
		 double y_1, double x_2, double y_2, double x_3, double y_3, double x_4, double y_4)
{
	//初始化输出矩阵
	vector<double> rv(3), tv(3);
	cv::Mat rvec(rv), tvec(tv);
