...
//if (p4psolver.Solve(PNPSolver::METHOD::CV_P3P) == 0 && p4psolver.Position_OcInW.z<-2300 && p4psolver.Position_OcInW.z>-3500)
//    cout <<"test2:CV_P3P方法:  相机位姿→" <<"Oc坐标=" << p4psolver.Position_OcInW <<"    相机旋转=" << p4psolver.Theta_W2C << endl;
//if (p4psolver.Solve(PNPSolver::METHOD::CV_ITERATIVE) == 0 && p4psolver.Position_OcInW.z<-2300 && p4psolver.Position_OcInW.z>-3500)
